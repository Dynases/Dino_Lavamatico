...
#Region "Metodos Privados"
    ...
    Private Sub _prCargarDetalleVenta(_numi As String)
        ...
        '      a.cbnumi ,a.cbtv1numi ,a.cbty5prod ,b.yfcdprod1 as producto,a.cbest ,a.cbConversion 
        ...
        With grdetalle.RootTable.Columns("venta")
            ...
            .Visible = False
        End With
        With grdetalle.RootTable.Columns("cbConversion")
            .Width = 100
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .Visible = True
            .FormatString = "0.00"
        ...
        End With
        With grdetalle.RootTable.Columns("cbUMax")
            .Width = 100
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .Visible = False
            .Caption = "UN. Min".ToUpper
        End With
        With grdetalle.RootTable.Columns("UnidadMin")
            .Width = 100
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .Visible = True
            .Caption = "Unidad Min.".ToUpper
        End With
        With grdetalle.RootTable.Columns("cbMedida")
            .Width = 100
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .Visible = False
            .Caption = "Medida"
    ...
    Public Sub P_PonerTotal(rowIndex As Integer)
        If (rowIndex < grdetalle.RowCount) Then
            ...
            Dim cant As Double = grdetalle.GetValue("cbConversion")
            Dim uni As Double = grdetalle.GetValue("cbpcost")
            If (pos >= 0) Then
                Dim TotalUnitario As Double = cant * uni
                'grDetalle.SetValue("lcmdes", montodesc)
                'Multiplica el cantidad que ingresara al Conversion por cantidad ue ingresa al inventario
                CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbcmin") = CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbMedida") * cant
...
#Region "Eventos Formulario"
        ...
        If (_fnAccesible()) Then
            If e.KeyData = Keys.Control + Keys.Enter Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    End If
                Else
                    ToastNotification.Show(Me, "Seleccione registrar un proveedor", My.Resources.WARNING, 3000, eToastGlowColor.Red, eToastPosition.TopCenter)
                End If
    ...
    Private Sub grdetalle_EditingCell(sender As Object, e As EditingCellEventArgs) Handles grdetalle.EditingCell
        If (_fnAccesible()) Then
            ...
            If (_estadoPor = 0) Then
                If (e.Column.Index = grdetalle.RootTable.Columns("cbConversion").Index Or e.Column.Index = grdetalle.RootTable.Columns("cbpcost").Index) Then
                    e.Cancel = False
                Else
                    e.Cancel = True
                End If
    ...
    Private Sub grdetalle_KeyDown(sender As Object, e As KeyEventArgs) Handles grdetalle.KeyDown
        ...
        If (e.KeyData = Keys.Enter) Then
            ...
            If (grdetalle.Col = grdetalle.RootTable.Columns("cbConversion").Index) Then
...
salirIf:
        ...
        If (e.KeyData = Keys.Enter) Then
            ...
            If (f >= 0) Then
                ...
                If ((pos >= 0) And (Not existe)) Then
                    ...
                    CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbcmin") = grProductos.GetValue("conversion")
                    CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbConversion") = 1
                    CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbUMax") = grProductos.GetValue("yfumax")
                    CType(grdetalle.DataSource, DataTable).Rows(pos).Item("UnidadMin") = grProductos.GetValue("UnidMin")
                    CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbMedida") = grProductos.GetValue("conversion")
    ...
    Private Sub grdetalle_CellValueChanged(sender As Object, e As ColumnActionEventArgs) Handles grdetalle.CellValueChanged
        ...
        Dim pos As Integer = -1
        _fnObtenerFilaDetalle(pos, lin)
        If (e.Column.Index = grdetalle.RootTable.Columns("cbConversion").Index) Then
            If (Not IsNumeric(grdetalle.GetValue("cbConversion")) Or grdetalle.GetValue("cbConversion").ToString = String.Empty) Then
                CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbConversion") = 1
                CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbptot") = CType(grdetalle.DataSource, DataTable).Rows(pos).Item("cbpcost")
            Else
                If (grdetalle.GetValue("cbConversion") > 0) Then
        ...
        If (e.Column.Index = grdetalle.RootTable.Columns("cbpcost").Index) Then
            If (Not IsNumeric(grdetalle.GetValue("cbpcost")) Or grdetalle.GetValue("cbpcost").ToString = String.Empty) Then
                Dim cantidad As Double = grdetalle.GetValue("cbConversion")
        ...
        '     a.cbnumi ,a.cbtv1numi ,a.cbty5prod ,b.yfcdprod1 as producto,a.cbest ,a.cbConversion ,a.cbumin ,Umin .ycdes3 as unidad,a.cbpcost 
    ...
    Private Sub grdetalle_CellEdited(sender As Object, e As ColumnActionEventArgs) Handles grdetalle.CellEdited
        If (e.Column.Index = grdetalle.RootTable.Columns("cbConversion").Index) Then
            If (Not IsNumeric(grdetalle.GetValue("cbConversion")) Or grdetalle.GetValue("cbConversion").ToString = String.Empty) Then
                ...
                grdetalle.SetValue("cbConversion", 1)
