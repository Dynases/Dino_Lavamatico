...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_fnGrabarProducto(tbCodigo.Text, tbCodProd.Text, tbCodBarra.Text, tbDescPro.Text,
                                                ...
                                                quitarUltimaFilaVacia(CType(dgjDetalleProducto.DataSource, DataTable).DefaultView.ToTable(False, "yfanumi", "yfayfnumi", "yfasim", "yfadesc", "estado")), IIf(swInventario.Value = 1, 0, 1), tbMedida.Text)
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelo.Celda)
        ...
        listEstCeldas.Add(New Modelo.Celda("yfMedida", False))
    ...
    Public Overrides Sub _PMOMostrarRegistro(_N As Integer)
        ...
        With JGrM_Buscador
            ...
            swInventario.Value = IIf(.GetValue("yfmstk") = 1, 0, 1)
            ...
            chbServicio.Checked = IIf(cbgrupo1.Text = "NO EXISTE", False, True)
            chbDetergente.Checked = IIf(cbgrupo2.Text = "NO EXISTE", False, True)
            chbSuavisante.Checked = IIf(cbgrupo3.Text = "NO EXISTE", False, True)
            chbOtros.Checked = IIf(cbgrupo4.Text = "NO EXISTE", False, True)
            tbMedida.Text = .GetValue("yfMedida")
...
#End Region
    ...
    Private Sub chbServicio_CheckedChanged(sender As Object, e As EventArgs) Handles chbServicio.CheckedChanged
        If chbServicio.Checked Then
            lbgrupo1.Visible = True
            cbgrupo1.Visible = True
        Else
            lbgrupo1.Visible = False
            cbgrupo1.Visible = False
        End If
    ...
    Private Sub chbOtros_CheckedChanged_1(sender As Object, e As EventArgs) Handles chbOtros.CheckedChanged
