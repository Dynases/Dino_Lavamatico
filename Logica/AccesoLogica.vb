...
#Region "TY005 PRODUCTOS"
    ...
    Public Shared Function L_fnGrabarProducto(ByRef _yfnumi As String, _yfcprod As String,
                                              ...
                                              _yfimg As String, TY0051 As DataTable, _inventario As Integer, _yfMedida As Double
                                              ) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@yfmstk", _inventario))
        ...
        _listParam.Add(New Datos.DParametro("@yfMedida", _yfMedida))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TY005", _listParam)
    ...
    Public Shared Function L_fnModificarProducto(ByRef _yfnumi As String, _yfcprod As String,
                                                 ...
                                                 TY0051 As DataTable, _inventario As Integer, _yfMedida As Double
                                              ) As Boolean
        Dim _resultado As Boolean
...
#Region "TV001 Ventas"
    ...
    Public Shared Function L_fnListarProductosFiltradoAccion(_almacen As String, _cliente As String, _grup2 As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarProductosFiltradoServicio(_cliente As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarProductosFiltradoDetergente(_cliente As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarProductosFiltradoSuavisante(_cliente As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarProductosFiltradoOtros(_cliente As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "Facturar"
    ...
    Public Shared Sub L_Grabar_Factura_Detalle(_Numi As String, _CodProd As String, _DescProd As String, _Cant As String, _Precio As String, _Numi2 As String, _Total As String)
        Dim Sql As String
        Try
            Sql = _Numi + ", '" + _CodProd + "', '" + _DescProd + "', " + _Cant + ", " + _Precio + ", " + _Numi2 + ", " + _Total
...
#Region "REPORTE DE SALDOS DE PRODUCTO AGRUPADOS POR LINEAS"
    ...
    Public Shared Function L_fnUnaAlmacenUnaLineasMayorCero(numiLinea As Integer, CodAlmacen As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnBuscarSaldoCategoria(_valor As String, almacen As Boolean, _grupo As Integer, _grupoStock As Boolean, _grupoTodos As Boolean, _idGrupo1 As Integer, _idGrupo2 As Integer, _idGrupo3 As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim sb As New StringBuilder
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnBuscarSaldoTodosCategoria(_valor As String, almacen As Boolean, _grupoStock As Boolean) As DataTable
        Dim _Tabla As DataTable
        Dim sb As New StringBuilder
        sb.Append("SELECT 
		                deposito.abnumi, 
