...
#Region "Metodos Privados"
    ...
    Private Sub _prCargarProductos()
        ...
        With grproducto.RootTable.Columns("stock")
            ...
            .Caption = "STOCK"
        End With
        With grproducto.RootTable.Columns("yfMedida")
            .Width = 120
            .Visible = True
            .FormatString = "0.00"
            .Caption = "MEDIDA"
        ...
        With grproducto.RootTable.Columns("ycdes3")
            ...
            .Caption = "UNIDAD MIN."
        End With
        With grproducto.RootTable.Columns("yfusup")
            .Width = 150
            .Visible = False
            .FormatString = "0.00"
        End With
        With grproducto.RootTable.Columns("yfvsup")
            .Width = 120
            .Visible = True
            .FormatString = "0.00"
            .Caption = "CONVERSION"
        End With
        With grproducto.RootTable.Columns("yfumin")
            .Width = 120
            .Visible = False
            .FormatString = "0.00"
            .Caption = "Cod Unidad Max."
        End With
        With grproducto.RootTable.Columns("yfUmax")
            .Width = 120
            .Visible = True
            .FormatString = "0.00"
            .Caption = "UNIDAD MAX."
